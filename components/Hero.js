        ...
        <div className="flex flex-col lg:flex-row justify-center  lg:justify-between items-center gap-5">
          <div className="flex flex-col gap-5 lg:gap-10">
            <p className=" text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-medium">
              A Unique approach <br className="lg:flex hidden"/> to Data Security <br className="lg:flex hidden" /> and Privacy.
            </p>
            <p className="text-sm sm:text-base lg:text-lg text-gray-500">
              Protect at your own data, with lifetime <br  className="lg:flex hidden"/> access on mobile and desktop
            </p>
